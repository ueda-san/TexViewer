...
namespace ASTCLoader
{
    public class ASTCLoader : ITexViewerPlugin
    {
        public string PluginName => "ASTC Loader";
        public string PluginDescription => "Load images using ARM astc-encoder";
        public string SupportedExtensions => "astc,ktx";
        public UInt16 DefaultPriority => 200;

        [DllImport("ASTCLoaderLib.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr get_version();
        [DllImport("ASTCLoaderLib.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        public static extern int load_file(string file, out LoadResult result);
        [DllImport("ASTCLoaderLib.dll", CallingConvention = CallingConvention.Cdecl)]
