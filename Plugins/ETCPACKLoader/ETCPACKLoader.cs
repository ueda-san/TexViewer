...
namespace ETCPACKLoader
{
    public class ETCPACKLoader : ITexViewerPlugin
    {
        public string PluginName => "ETCPACK Loader";
        public string PluginDescription => "Load images using Ericsson ETCPACK library";
        public string SupportedExtensions => "pkm,ktx";
        public UInt16 DefaultPriority => 220;

        [DllImport("ETCPACKLoaderLib.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr get_version();
        [DllImport("ETCPACKLoaderLib.dll", CallingConvention = CallingConvention.Cdecl)]
